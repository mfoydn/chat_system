<nav class="navbar navbar-default" style="background-color: #03A9F4;>
    <div class="container-fluid">
		<div class="navbar-header">
			<a class="navbar-brand" href="">Tuzungumze</a>
		</div>

		<ul class="nav navbar-nav">
			<li><a href="index.php"><span class="glyphicon glyphicon-home"></span>Hi <?php echo $user; ?>!!!! </a></li>
		</ul>
