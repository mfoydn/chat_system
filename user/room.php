		<div class="col-lg-8">
			...
			<div>
				<div class="panel panel-default" style="height: 400px;">
					<div style="height:10px;"></div>
					<span style="margin-left:10px;">Welcome to Chatroom <?php echo $user; ?></span><br>
					<span style="font-size:10px; margin-left:10px;"><i>Note: Avoid using abuse language and hate speech to avoid banning of account</i></span>
					<div style="height:10px;"></div>
